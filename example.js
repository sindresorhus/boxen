...
const footer = 'Beautiful footer';
console.log('\n\n' + boxen('This box has a nice footer', {footer}) + '\n');

console.log('\n\n' + boxen('This box has a centered footer', {footer, footerAlignment: 'center'}) + '\n');

console.log('\n\n' + boxen('This box has a right aligned footer', {footer, footerAlignment: 'right'}) + '\n');

console.log('\n\n' + boxen('This box has a title and a footer', {title, footer}) + '\n');
